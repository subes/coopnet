...
public class Icons {
    ...
    public static ImageIcon lobbyIconSmall = new ImageIcon(Toolkit.getDefaultToolkit().getImage(Globals.getResourceAsString("data/icons/playerstatus/inlobby.png")).getScaledInstance(16, 16, Image.SCALE_SMOOTH));
